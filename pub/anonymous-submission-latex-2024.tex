...
\todo{Did not evaluate vSGD since its old and there is no implementation. Is that valid?}
...
-Mechanic: can wrap around any first order algorithm, removing the need of tuning $\eta$, % uses an update formula similar to AdaGrad enhanced by an adaptive decay of the second order moment estimate
