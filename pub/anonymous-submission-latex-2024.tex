...
In other works, the issue of lacking adaptability due to insufficient learning rates is often times simply avoided by using a less aggressive or cyclic learning rate.\todo{Add Sources}
...
\begin{figure}
	\centering
	\includegraphics[width=.45\textwidth]{figures/runtimes_3hidden.pdf}
...
\begin{figure}
	\centering
	\includegraphics[width=.45\textwidth]{figures/pretune_1x128_acc_lr_exp_schedule.pdf}
...
\begin{figure}
	\centering
	\includegraphics[width=0.47\textwidth]{figures/lr_norms_insects_abrupt.pdf}
...
\begin{figure}
	...
	\begin{subfigure}[h]{0.2\textwidth}
		\centering
		\includegraphics[height=3.4cm, keepaspectratio]{figures/sgd_trajectory_batch_sizes_0.5_lr.pdf}
		\caption{$\eta = 0.5$}\label{fig:trajectory_batch_sizes_0.5_lr}
	\end{subfigure}
	\begin{subfigure}[h]{0.26\textwidth}
		\centering
		\includegraphics[height=3.4cm, keepaspectratio]{figures/sgd_trajectory_batch_sizes_best_lr.pdf}
